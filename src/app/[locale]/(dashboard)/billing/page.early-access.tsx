...
// Billing page — early access mode.
// Stripe is paused. Users can leave contact details and we'll reach out personally.
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" value={name} onChange={e => setName(e.target.value)}
                    ...
                    style={{ border: '0.5px solid #d1d5db', color: '#111827' }} />
                </div>
                <div>
