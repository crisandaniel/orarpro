...
-- Run this for a clean slate before re-running migrations.
...
drop table if exists public.school_assignments          cascade;
drop table if exists public.school_configs              cascade;

-- School resources
drop table if exists public.school_teacher_unavailability cascade;
...
-- Old school tables (from 003_schedules.sql v1)
